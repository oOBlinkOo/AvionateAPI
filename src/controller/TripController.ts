...
router.get('/getFullCar/:id_trip', function(req, res, next) {
  console.log('llegamos hasta el getlist del trip',req.params);
...
router.get('/getListbyUser/:id_user', function(req, res, next) {
  console.log('llegamos hasta el getlist del trip',req.params);
  
// res.send(req.params);
  tripDao.getListByUser(
                req.params.id_user
...
router.get('/closeTrip/:id_trip', function(req, res, next) {
  console.log('llegamos hasta el getlist del trip',req.params);
